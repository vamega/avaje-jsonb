...
class CustomBuilderMessageTest {

  @Test
  void toJson() {
    var message = CustomBuilderMessage.builder()
        .withId("123")
  ...
  void fromJson() {
    ...
    var jsonb = Jsonb.instance();
    var message = jsonb.type(CustomBuilderMessage.class).fromJson(json);
  ...
  @Test
  void roundTrip() {
    var original = CustomBuilderMessage.builder()
    ...
    var deserialized = jsonb.type(CustomBuilderMessage.class).fromJson(json);
